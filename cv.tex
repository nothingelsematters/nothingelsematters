...
\cvSection{Professional Experience}
    ...
    \cvEntry
        ...
        {Aug 2024 -- present} {7 mos}
        {Full-time · Berlin, Germany}
        {
            Fulfillment Offering Team \\
            \vspace{-5mm}
            \begin{cvItems}
                \item Developed backend services responsible for aggregating delivery options and time promises using \underline{Kotlin}
                \item Connected the team with Mobile Apps and Web teams to make UI changes using \underline{TypeScript}
                %\item set up \underline{CDN}
                %\item tested iOS application using \underline{xcode}, \underline{Swift}
            \end{cvItems}
        }
