...
\setupblackrules[width=28mm, color=rulecolor]
...
\definedescription
  [description]
  [headstyle=normal, style=normal, location=hanging, width=23mm, distance=6mm, margin=0cm]
